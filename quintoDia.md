...
A Entrega do Projeto deve ser feita via email. O aluno deve enviar um email com o assunto sendo:

"Projeto Final Minicurso Spring - [Nome do Aluno]"

Contendo um arquivo .zip com a pasta do projeto compactada.

O email deve ser enviado para: petcc@dimap.ufrn.br
